...
#define OTG_TARGET_LAG  96
#define OTG_LAG_MIN     48
#define OTG_LAG_MAX     192
...
static volatile unsigned s_ring_otg_rd = OUT_RING_SIZE - OTG_TARGET_LAG;
