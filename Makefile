...
OBJS = main.o kernel.o kernel_run.o multicore.o coreDispatch.o paramSnapshot.o audio.o app.o apcKey25.o apcKey25Transpose.o apcKey25Notes.o apcKey25Filters.o usbMidi.o \
